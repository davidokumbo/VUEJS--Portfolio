<template>
  <div>
      ...
      <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div v-for="(project, index) in projects" :key="index" 
            ...
            <img :src="project.images[0]" :alt="project.title" class="w-full h-64 object-cover transition-transform duration-300 group-hover:scale-110">
    ...
    <!-- Modal -->
    <teleport to="body">
      <div v-if="showModal" class="fixed inset-0 bg-gray-900 bg-opacity-90 z-50 overflow-y-auto">
          ...
          <div class="bg-gray-800 w-full max-w-4xl lg:max-w-6xl xl:max-w-7xl rounded-lg overflow-hidden flex flex-col relative">
            ...
            <div class="flex flex-col lg:flex-row">
              ...
              <div class="w-full lg:w-1/2 relative">
                ...
                <div class="absolute top-1/2 transform -translate-y-1/2 flex justify-between w-full px-4" v-if="!selectedProject.videoUrl">
...
const projects = ref([
  {
    ...
    videoUrl: null, // Add video URL here
